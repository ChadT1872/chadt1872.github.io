...
function loadArt(e) {
    var artsources = ["assets/moonthief.PNG", "assets/moonthief_2.PNG", "assets/ColorSpace.png", "assets/ColorSpace1.png", "assets/SpaceDragonPlanetEater.png", "assets/ScribingontheWalls.png", "assets/oldman.png", "assets/kidandmonster.png", "assets/kidandmonster2.png", "assets/GrimReaper.png", "assets/GrimReaper1.png", "assets/GhostinLibrary.png", "assets/EgyptianHeads.png", "assets/diseases.png", "assets/BohdiSpaceTree.png", "assets/submarine.png"];
    var artname = ["Moon Thief", "Older Moon Thief", "Color Space", "Color Space Alternate", "Space Dragon Planet Eater", "Scribing on the Walls", "old man", "Kid & Monster", "Kid & Monster: 2nd Evolution", "Grim Reaper", "Grim Reaper 2", "Library Ghost", "Egyptian Bald", "Humanoid Diseases", "Bohdi Space Tree", "Submarine Blood"];
